...
export function buildTuiReleaseRequest({
  capabilityManifest,
  packageManifest,
  capabilityManifestPath = "",
  packageManifestPath = "",
  repository = "GameCult/EveTui",
} = {}) {
  ...
  const artifactPath = replaceVersion(
    releaseContract.artifactPattern || `artifacts/evetui-release/{version}/${releaseContract.packageName}-{version}.tgz`,
...
function runCli() {
  ...
  const request = buildTuiReleaseRequest({
    ...
    repository: args.repository || "GameCult/EveTui",
  });
