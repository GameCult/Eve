...
test("builds Electron shell capture request for Aetheria editor surface", () => {
  const request = buildElectronCaptureRequest({
    advertisement,
    capabilityManifest,
...
test("builds Electron shell capture request from a declared generic world provider", () => {
  const request = buildElectronCaptureRequest({
