...
test("builds Unity UI Toolkit capture artifact for a generic world provider", () => {
  const { projection } = buildUnityUiToolkitCaptureArtifact({
  ...
  assert.equal(projection.root.children[1].visualElementKind, "VisualElement");
});
